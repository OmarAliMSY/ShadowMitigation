...
le= ["jpg","jpeg"]
FH = FileHandler(dataset_path=r"C:\Users\o.abdulmalik\Documents\SUNSET\2017_11_images_raw",foldername="11",legal_extensions=le)
...
#
    ...
    cv2.imwrite(filename=f'SKIPPD/05/{filename_without_ext}.jpg',img=save_im)
